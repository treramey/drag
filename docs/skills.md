...
| [`drag-tracking`](../skills/drag-tracking/SKILL.md) | Operate Drag automatic time tracking. Use when the user asks to configure approved local sources, inspect tracking health, run or review a day, manage the schedule, or change submission policy. |
